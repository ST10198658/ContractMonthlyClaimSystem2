...
namespace ContractMonthlyClaimSystem.Controllers
{
    public class ClaimTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ModuleName,ModuleCode,Description,Sessions,Groups,Rate,CreatedById,CreatedOn,ModifiedById,ModifiedOn")] ClaimType claimType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ModuleName,ModuleCode,Description,Sessions,Groups,Rate,CreatedById,CreatedOn,ModifiedById,ModifiedOn")] ClaimType claimType)
        {
            if (id != claimType.Id)
            {
                return NotFound();
