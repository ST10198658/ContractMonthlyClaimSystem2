...
namespace ContractMonthlyClaimSystem.Controllers
{
    public class LecturersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,FirstName,LastName,Email,DateofBirth,Phone,ModuleCode,ModuleName,Country,Address,Department,CreatedById,CreatedOn,ModifiedById,ModifiedOn")] Lecturer lecturer)
        {
            if (id != lecturer.Id)
            {
                return NotFound();
